...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\dakma\Documents\maeng\git\pythonProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\dakma\Documents\maeng\git\pythonProject\venv\Scripts\deactivate.nu'
